...
export default function HomeFooter() {
  return (
    ...
    <div>
          ...
          <footer style={{marginTop:'100px'}} className={style.fontsize}>
             <Row>
             ...
             <Button variant="dark" style={{ borderRadius:'50%' , border:'none', paddingBottom:'10px'  }} className='ms-5 me-2'>
                ...
                <Button variant="dark" style={{ borderRadius:'50%' , border:'none' ,  paddingBottom:'10px'}} className='mx-2'>
             ...
             <div style={{marginTop:'40px',marginBottom:'70px'}}>
                <hr className='mx-4' style={{color:'#b5bcc3'}}/>
                <p  className='mx-4 my-5' style={{color:'#b5bcc3', fontSize:'14px'}}>
                © 2024 Spotify 
                </p>
             </div>
