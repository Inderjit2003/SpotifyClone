...
},
{
  ...
  const renderMainComponent = () => {
    switch (location.pathname) {
      ...
      default:
        return <AllCards data={data} handleCardClick={handleCardClick}  handleMouseEnter={handleMouseEnter} handleMouseLeave={handleMouseLeave} />; // Handle other routes if needed
    }
  };
  ...
  const handleMouseLeave = (type) => {
   ...
   const data ={ artist, album, radio, playlist}
