...
import AllCards from './AllCards'; // Import the ShowAll component

export default function Showall({ artist }) {
    const [showAllClicked, setShowAllClicked] = useState(false); // Initialize state
